...
export const Hero = () => {
  return (
    <Container as="section" aria-labelledby="hero-title">
      <div className="relative isolate overflow-hidden bg-white dark:bg-black rounded-md gap-6 md:px-12 :px-24 md:pt-0 mt-8 grid md:grid-cols-2 shadow-xl border">
